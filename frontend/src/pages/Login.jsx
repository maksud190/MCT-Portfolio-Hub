    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          {/* <div className="mx-auto h-16 w-16 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="bg-stone-900/50 rounded-sm shadow-2xl p-8 space-y-6 border border-stone-800">
            {/* Email Input */}
            <div>
        ...
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-40 h-40 bg-amber-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
        <div className="absolute top-0 right-0 w-40 h-40 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-0 left-20 w-40 h-40 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
    </div>
  );
}