...
//           <h1 className="!text-7xl font-extrabold mb-4 text-stone-800">Discover Amazing Projects</h1>
...
//             <br />
//             <span className="text-sm text-stone-800">-Multimedia and Creative Technology</span>
//           </p>
//         </div>
...
//             <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-6 gap-8 px-12">
    ...
    <div>
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-6 py-0">
          ...
          {/* Projects Grid - Simple Grid Layout (No Masonry) */}
          {filteredProjects.length > 0 ? (
